...
final class CalendarViewController: UIViewController {
    ...
    func setupViews() {
        ...
        fromDatePickerView.title = "Select"
        toDatePickerView.title = "Select"
        view.backgroundColor = UIColor(red: 250, green: 250, blue: 250, alpha: 1.0)
        topView.backgroundColor = .gray.withAlphaComponent(0.3)
        let width = (UIScreen.main.bounds.width - 100) / 7
...
extension CalendarViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            ...
            sectionHeader.label.text = self.currentDate?.toString(with: "MMMM")
